...
CREATE TABLE `accessRecords` (
  ...
  `event` enum('VIEW_MESSAGES','VIEW_PATIENTS','VIEW_BOOKINGS','VIEW_VISITS','VIEW_NEWVISIT','VIEW_WELCOMESCREEN') CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL
